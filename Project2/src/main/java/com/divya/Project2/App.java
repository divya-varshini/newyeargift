...
public class App 
{
	...
	public static void main( String[] args )
    {
        ...
        System.out.println("enter lower limit for candies (available costs of candies here: 5,10,15)");
        lowlimit=in.nextInt();
        System.out.println("enter  higher limit for candies (available costs of candies here: 5,10,15)");
